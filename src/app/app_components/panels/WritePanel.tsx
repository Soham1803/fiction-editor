...
export default function WritePanel(props: {rightCollapsed: boolean}) {
    ...
    return (
      ...
      <div className="w-full h-[93%] py-2 px-1">
        <div className="w-full text-center">
          <h2 className={cn(props.rightCollapsed ? "w-[75%]" : "w-full")}>
            {manuscript?.act.name}
          </h2>
        </div>
        ...
        <div className="w-full h-[100%] overflow-y-auto overflow-x-hidden">
          <div className="w-full">
                  ...
                  {chapter.scenes.map((scene, sindex) => (
                    <div className="w-full" key={sindex}>
                      ...
                      >
                        <h4
                          className={cn(
                            props.rightCollapsed ? "w-[75%]" : "w-full",
            ...
            <button
              className="flex items-center ml-2 p-1 mb-5 rounded-theme bg-primary text-xs hover:bg-secondary hover:text-primary"
