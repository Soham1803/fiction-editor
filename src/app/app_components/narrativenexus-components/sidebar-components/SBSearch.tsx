  ...
  const [choosenEntityType, setChoosenEntityType] = useState<EntityType | "">("");
    return (
      ...
      <div className="relative h-10 w-full bg-secondary flex flex-row items-center justify-between py-1 px-2 text-text-secondary mt-secondary">
        <AddEntity className={"absolute z-10 right-72 top-3 w-[40vw] h-[80vh] opacity-100"} setChoosenEntityType={setChoosenEntityType} entity={{type:choosenEntityType, name:"Soham Panchal", tag:["Protagonist"], aliases: ["Soham", "Panchal"], description: "Son of God!", inspiration: "God", image: "image", mentions: ["here", "there"]}} />
